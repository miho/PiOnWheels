...
public class VSysUtil {
    ...
    public static final String[] SUPPORTED_OPERATING_SYSTEMS
    ...
    /**
     * Returns the architecture name, i.e., <code>x64</code> or <code>x86</code>
     * or <code>generic</code>.
     *
     * <p>
     * <b>Note:</b> names returned by this method are compatible with native
    ...
    /**
     * Returns the name of the OS, i.e., <code>linux</code> or <code>osx</code>
     * or <code>windows</code> or <code>generic</code>.
     *
     * <p>
     * <b>Note:</b> names returned by this method are compatible with native
     * library and resource locations for VRL and VRL plugins.</p>
     ...
     * <code>linux/x64</code> or <code>windows/x86</code>.
     *
     ...
     * returned. </p>
     * <p>
     * <b>Note:</b> in contrary to <code>System.getProperty()</code> only the
     * base name will be returned. See {@link #SUPPORTED_OPERATING_SYSTEMS}.
     * </p>
     *
     * @return the OS name
     */
     ...
     *
     * <p>
     * <b>Note:</b> this method is currently not supported on Windows. It
     * requires the Unix program <code>which</code></p>.
     *
     ...
     *
     * <p>
     * <b>Note:</b> on Windows this method will return <code>false</code> even
     * though KDE running (e.g. through Cygwin). </p>
     *
     * @return <code>true</code> if KDE 4 is running;<code>false</code>
     * otherwise
     */
     ...
     * <p>
     * <b>Note:</b> on Windows this method will return <code>false</code> even
     * if Gnome or Unity is running (e.g. through Cygwin). </p>
     *
     * @return <code>true</code> if Gnome or Unity is running;<code>false</code>
     * otherwise
     */
     ...
     *
     * <p>
     * <b>Note:</b> be careful. Using this method can do serious damage to the
     * users data! Before considering the use of this method be sure you really
     * need it. </p>
     *
